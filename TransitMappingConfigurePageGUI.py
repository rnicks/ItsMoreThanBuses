...
##########################################################################################
    ...
    def selectGrid(self):
        if self.OS == "OSX" or self.OS == "Linux":
            self.gridFilePath = askopenfilename(initialdir = "/", title = "Select Shape File", filetypes=(("SHP Files", "*.shp"), ("all files", "*.*")))

        elif self.OS == "Windows":
            self.gridFilePath = askopenfilename(initialdir = "C:\\", title = "Select Shape File", filetypes=(("SHP Files", "*.shp"), ("all files", "*.*")))
